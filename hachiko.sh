...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/HACHEJOTA/HachikoBot-MD\ncd HachikoBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/HACHEJOTA/HachikoBot-MD.git
...
menu_ayuda() {
	...
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/BMGMxj6cU9o4S3huVByLFc &>> /dev/null
...
echo -e "\033[01;32m\033[01mIniciando HachikoBot-MD!!\nBy HacheJota!!\n\033[0m"
npm start
