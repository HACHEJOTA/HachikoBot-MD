...
const handler = async (m, {conn, text, participants, isOwner, isAdmin}) => {
  try {
    ...
    const msg = conn.cMod(m.chat, generateWAMessageFromContent(m.chat, {[m.quoted ? q.mtype : 'extendedTextMessage']: m.quoted ? c.message[q.mtype] : {text: '' || c}}, {quoted: twa, userJid: conn.user.id}), text || q.text, conn.user.jid, {mentions: users});
