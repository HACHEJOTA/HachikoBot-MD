...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por HacheJota, tu seras Hachiko - Bot.`;
...
handler.command = /^(openai|chatgpt|ia|robot|openai2|chatgpt2|ia2|robot2|Hachiko|HachikoBot)$/i;
