...
${cmenut}
${cmenub} *𝙸𝙳:* ${kt[1][0].id}
${cmenub} *𝙲𝙸𝚄𝙳𝙰𝙳:* ${kt[1][0].capitalCity}
${cmenub} *𝙻𝙾𝙽𝙶𝙸𝚃𝚄𝙳:* ${kt[1][0].longitude}
${cmenub} *𝙻𝙰𝚃𝙸𝚃𝚄𝙳:* ${kt[1][0].latitude}
${cmenuf}
...
${cmenua}`;
    ...
    conn.reply(
        m.chat,
        '*[❗] 𝙾𝙲𝚄𝚁𝚁𝙸𝙾 𝚄𝙽 𝙴𝚁𝚁𝙾𝚁, 𝙸𝙽𝚃𝙴𝙽𝚃𝙰𝙻𝙾 𝙳𝙴 𝙽𝚄𝙴𝚅𝙾, 𝚂𝙴𝙶𝚄𝚁𝙾 𝙻𝙰 𝙰𝙿𝙸 𝙽𝙾 𝙶𝙴𝙽𝙴𝚁𝙾 𝙻𝙰 𝙸𝙼𝙰𝙶𝙴𝙽*',
        m,
    );
  }
};
