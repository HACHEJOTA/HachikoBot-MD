...
const handler = async (m, {text, conn, args, usedPrefix, command}) => {
  ...
  try {
   ...
   if (fileSizeInMB > 50) {
    await conn.sendMessage(m.chat, {document: buff, caption: `*◉—⌈wm⌋—◉*\n🔰 𝚃𝙸𝚃𝚄𝙻𝙾:* ${ttl_1}\n*◉—⌈hachejota⌋—◉**`, fileName: ttl_1 + '.mp3', mimetype: 'audio/mpeg'}, {quoted: m});
    ...
    await conn.sendMessage(m.chat, {audio: buff, caption: `*◉—⌈wm⌋—◉*\n*▢ Titulo:* ${ttl_1}\n*◉—⌈hachejota⌋—◉*`, fileName: ttl_1 + '.mp3', mimetype: 'audio/mpeg'}, {quoted: m});
