...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  if (!args[0]) throw `*[❗] 𝙸𝙽𝙶𝚁𝙴𝚂𝙴 𝙴𝙻 𝙽𝙾𝙼𝙱𝚁𝙴 𝙳𝙴 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙳𝙴 𝚄𝙽 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙳𝙴 𝙸𝙽𝚂𝚃𝙰𝙶𝚁𝙰𝙼, 𝙴𝙹𝙴𝙼𝙿𝙻𝙾: ${usedPrefix + command} golencitogames*`;
  ...
  const iggs = `
▢ *𝚄𝚂𝙴𝚁𝙽𝙰𝙼𝙴:* ${json.username}
▢ *𝙽𝙸𝙲𝙺𝙽𝙰𝙼𝙴:* ${json.fullname}
▢ *𝙵𝙾𝙻𝙻𝙾𝚆𝙴𝚁𝚂:* ${json.followers}
▢ *𝙵𝙾𝙻𝙻𝙾𝚆𝙸𝙽𝙶:* ${json.following}
▢ *𝙿𝙾𝚂𝚃𝙸𝙽𝙶:* ${json.post}
▢ *𝙻𝙸𝙽𝙺:* https://instagram.com/${json.username.replace(/^@/, '')}
▢ *𝙱𝙸𝙾:* ${json.bio}`.trim();
