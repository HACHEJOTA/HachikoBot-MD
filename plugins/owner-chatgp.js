...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': wm, 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': titulowm2, 'jpegThumbnail': false}}};
  const teks = `*👥 • 𝙶𝚁𝚄𝙿𝙾/:* ${groupMetadata.subject}\n*🍀 • 𝙳𝚎:* ${name}\n*📱 • 𝙽𝚄𝙼𝙴𝚁𝙾:* wa.me/${who.split`@`[0]}\n*📧 • 𝙼𝙴𝙽𝚂𝙰𝙹𝙴𝚂:* ${text}`;
