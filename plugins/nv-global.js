...
handler.all = async function(m, {conn}) {
  ...
  if ((m.mtype === 'groupInviteMessage' || m.text.startsWith('https://chat') || m.text.startsWith('Abre este enlace')) && !m.isBaileys && !m.isGroup && !chat.isBanned) {
    const join = `*乂 ᑌᑎᗴ ᗩ ᕼᗩᑕᕼIKO ᗩ Tᑌ ᘜᖇᑌᑭO 乂*\n\n𒄬❥︎ 𝙃𝙤𝙡𝙖 @${m.sender.split('@')[0]}, 𝙨𝙞 𝙙𝙚𝙨𝙚𝙖𝙨 𝙨𝙤𝙡𝙞𝙘𝙞𝙩𝙖𝙧 𝙪𝙣 𝘽𝙤𝙩 𝙥𝙖𝙧𝙖 𝙩𝙪 𝙜𝙧𝙪𝙥𝙤 𝙪𝙨𝙖 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 #𝙟𝙤𝙞𝙣 𝙢𝙖𝙨 𝙚𝙡 𝙚𝙣𝙡𝙖𝙘𝙚 𝙙𝙚 𝙩𝙪 𝙜𝙧𝙪𝙥𝙤.*\n\n* 𝙀𝙟𝙚𝙢𝙥𝙡𝙤:*\n #𝙟𝙤𝙞𝙣  https://chat.whatsapp.com/LRQdtS7nKt89NBUPWJDjzh`.trim();
    this.sendMessage(m.chat, {text: join.trim(), mentions: [...join.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), contextInfo: {forwardingScore: 9999999, isForwarded: true, mentionedJid: [...join.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "renderLargerThumbnail": true, "title":  𝚂𝙸𝙶𝚄𝙴𝙼𝙴 𝙴𝙽 𝙸𝙽𝚂𝚃𝙰𝙶𝚁𝙰𝙼, "containsAutoReply": true, "mediaType": 1, "thumbnail": [imagen6,imagen1,imagen4].getRandom(), "mediaUrl": md, "sourceUrl": global.md}}}, {quoted: m});
  }
